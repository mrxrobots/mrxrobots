...
┌──[darkvector@github]─[~]
└─$ whoami
  DarkVector — Bug Bounty Hunter & Cybersecurity Researcher
...
| Project | Description |
|--------|-------------|
| ☠️ [DarkVector Toolkit](https://github.com/mrxrobots/darkvector-toolkit) | Python-based cybersecurity tool |
| 📡 [WiFi Hacking Demo](https://github.com/mrxrobots/wifi-hacking-) | WPA2 handshake capture — Educational |
| 🎣 [QR Phishing Demo](https://github.com/mrxrobots/qr-phishing-demo) | QR code phishing awareness demo |
| 🐛 [Bug Bounty Notes](https://github.com/mrxrobots/bug-bounty-notes) | Personal bug bounty hunting notes |
| 🚩 [PicoCTF Writeups](https://github.com/mrxrobots/picoctf-writeups) | CTF challenge solutions |
